...
# model = load_model('/home/kolegor/Study/Master/experiments/dense__big(all_data__fit_generator)__sdc_215/model.big_again_11_lang__reload_retrained_extra_2_epochs.keras')
...
print 'Files'
print sum(len(b) for a, b in train_gen_data.iteritems())
print sum(len(b) for a, b in test_gen_data.iteritems())
print sum(len(b) for a, b in val_gen_data.iteritems())
...
if True:
    ...
    test_data_vectors = estimate_total_dataset_duration(test_gen_data, known_one_file_duration=5)
    train_data_steps = train_data_vectors / batch_size
    val_data_steps = val_data_vectors / batch_size
    test_data_steps = test_data_vectors / batch_size
    print train_data_vectors, train_data_steps
    print val_data_vectors, val_data_steps
    print test_data_vectors, test_data_steps
    ...
    # 1005041 2499481 0.402099875934
