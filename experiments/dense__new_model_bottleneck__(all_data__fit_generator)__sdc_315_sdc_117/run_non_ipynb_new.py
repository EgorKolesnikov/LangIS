...
model = load_model('/home/kolegor/Study/Master/experiments/dense__new_model_bottleneck__(all_data__fit_generator)__sdc_315_sdc_117/model.big_11_lang__bottleneck_nn__features_sdc_315_and_sdc_117.keras')
...
if False:
    ...
    model.save('/home/kolegor/Study/Master/experiments/dense__new_model_bottleneck__(all_data__fit_generator)__sdc_315_sdc_117/model.big_11_lang__bottleneck_nn__features_sdc_315_and_sdc_117.keras')
else:
    ...
    # 1161403 2205761 0.526531659595
